...
module.exports = [
    ...
    },
    {
        ...
        title: 'Коллекции',
        content: [
            '<p>В Cypher коллекции можно заполнять элементами различных типов данных.',
            '<p class="code"> RETURN [0,1.3,"str",n.prop] AS my_collection</p>',
            'Результат:',
            '<p class="result">my_collection</p>',
            '<p class="result">1 row</p>',
            '<p class="result">[0,1.3,"str","sample"]</p>',

            'Для обращения к отдельным элементам коллекции используются квадратные скобки:',
    ...
    },
    {
        ...
        content: [
            ...
            '<p> Создание узла с меткой:</p>',
            '<p class="code">CREATE (n:myLabel)</p>',
            '<p class="result">запрос не возвращает ничего</p>',
            '<p> Создание узла с несколькими метками:</p>',
            '<p class="code">CREATE (n:myLabel:myAnotherLabel)</p>',
            '<p class="result">запрос не возвращает ничего</p>',
    ...
    },
    {
        ...
        author: 'me',
        div: '2.0.',
        title: 'Создание и модификация узлов и отношений',
        content: [
            '<p>',
